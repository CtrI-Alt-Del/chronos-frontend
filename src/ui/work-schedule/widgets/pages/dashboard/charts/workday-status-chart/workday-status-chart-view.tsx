  ...
  const data = [
    {
      ...
      percentage: (workdayStatus.activateCollaborators /
        (workdayStatus.activateCollaborators + workdayStatus.vacationCollaborators + workdayStatus.withdrawCollaborators)) * 100
    },
    {
      name: 'Férias',
      value: workdayStatus.vacationCollaborators,
      percentage: (workdayStatus.vacationCollaborators /
        (workdayStatus.activateCollaborators + workdayStatus.vacationCollaborators + workdayStatus.withdrawCollaborators)) * 100
    },
    {
      name: 'Afastados',
      value: workdayStatus.withdrawCollaborators,
      percentage: (workdayStatus.withdrawCollaborators /
        (workdayStatus.activateCollaborators + workdayStatus.vacationCollaborators + workdayStatus.withdrawCollaborators)) * 100
    },
  ]
