...
export const SolicitationsAccordionView = <Solicitation extends SolicitationDto>({
  ...
  console.log("solicitations-solicitations-accordion-view", solicitations)
        ...
        {solicitations.map((solicitation) => (
          ...
          >
            <div className='pb-3 pl-5'>
              ...
              {isViewerManager && solicitation.status.toLowerCase() === 'pending' && (
                <div className='mt-6'>
                  <SolicitationActions
                    isLoading={isLoading}
                    ...
                    canCancel={solicitation.senderResponsible.id === currentUserId}
                  />
                </div>
              )}
            </div>
